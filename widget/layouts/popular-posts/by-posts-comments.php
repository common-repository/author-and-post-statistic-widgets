...
?>
<div class="apsw-tab">
    <h3 class="apsw-tab-title"><?php echo $this->optionsSerialized->ppMostCommentedPostsTitle; ?></h3>
    <div class="apsw-block apsw-popular-posts">
        <ul class="apsw-popular-posts-list">
            <?php
            $popularPosts = $this->dbManager->popularPostsByComments($from, $to, $postTypes, $limit, $excludeArgs);
            if ($popularPosts) {
