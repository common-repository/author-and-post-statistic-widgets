...
?>
<p>
    <label class="apsw-widget-label" for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'author-and-post-statistic-widgets'); ?></label>
    <input type="text" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>"  value="<?php echo esc_attr($instance['title']); ?>" />
</p>

<p>
    <label class="apsw-widget-label"><?php _e('Select date interval', 'author-and-post-statistic-widgets'); ?></label>
